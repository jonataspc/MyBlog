        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Content = table.Column<string>(type: "nvarchar(1000)", maxLength: 5120, nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Comment_IsActive",
                table: "Comment",
                column: "IsActive");

            migrationBuilder.CreateIndex(
                name: "IX_Comment_PostId_IsActive",
                table: "Comment",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Post_AuthorId_IsActive",
                table: "Post",
